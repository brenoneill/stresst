...
export function RepoBranchSelector({ repos: initialRepos, accessToken }: RepoBranchSelectorProps) {
  ...
  function calculateTimeDifference(): string {
    if (!startCommit || !completeCommit) return "";
        ...
        {showScorePanel && startCommit && completeCommit ? (
          <div className="flex h-full flex-col gap-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" onClick={() => setShowScorePanel(false)}>
            ...
            <div className="rounded-xl border border-gh-border bg-gradient-to-br from-gh-canvas-subtle to-gh-canvas-default p-6">
              <div className="text-center">
                <p className="text-sm font-medium text-gh-text-muted mb-2">Time to Complete</p>
                <p className="text-4xl font-bold text-gh-success-fg">{calculateTimeDifference()}</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex-1 pb-4">
                  <div className="rounded-lg border border-gh-border bg-gh-canvas-subtle p-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium text-white">Started Debugging</span>
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  <div className="rounded-lg border border-gh-border bg-gh-canvas-subtle p-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium text-white">Completed Fix</span>
                      <code className="rounded bg-gh-canvas-default px-2 py-0.5 font-mono text-xs text-gh-accent">
            ...
            <div className="mt-auto pt-4 border-t border-gh-border">
              <div className="flex items-center justify-between text-sm">
                ...
                <code className="font-mono text-gh-accent">{selectedBranch}</code>
              </div>
            </div>
          </div>
        ) : loadingDetails ? (
